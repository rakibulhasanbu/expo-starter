...
export default function AddMoneySuccessScreen() {
  ...
  const { usdAdded, transactionId } = useLocalSearchParams<{ usdAdded: string; transactionId: string }>();
      ...
      <View className="w-full gap-8">
        <View className="gap-2">
          ...
          <Text className="text-center text-base text-subtitle">
            {formatUsdBalance(Number(usdAdded))} has been added to your virtual card.
          </Text>
        </View>
